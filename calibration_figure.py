...
def main():
    ...
    ap.add_argument("--figure_cell", nargs=4, default=None,
                    ...
                    help="Only make one figure for this cell. Default: every cell.")
    args = ap.parse_args()
    ...
    print("\n" + "-" * 20)
    print("Calibration, Binned Expected Calibration Error")


    print(out.to_string(index=False))

    print("\n ECE 0 is perfect. Higher is worse. "
          "Because these models produce probabilities squashed into a narrow band, expect confidence to sit close "
          "to the base rate and ECE to be driven by that rather than by sharpness.")
